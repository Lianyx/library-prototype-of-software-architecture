...
import presentation.userui.UserUIController;
import utils.UIType;


public class AdminMainUIController extends CenterUIController {
...
//
    ...
    private void gotoBookManagement(){
        root.showLogoutButton(false);
        BookUIController.init(root, UIType.BOOK_MANAGEMENT);
    }
